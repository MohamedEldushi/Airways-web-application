...
<div class="container  mt-3 mb-5">
    ...
    <h2>Forgot Password</h2>
        ...
        <div id="resetForm"  class="form-group ">
            <button  type="submit">Send Password Reset Link</button>
        </div>  @if (session('status'))
        <div class="alert alert-success">
            {{ session('status') }}
        </div>
    @endif       <p class="info-text text-secondary">To reset your password for <span style="color: #0056b3" class="text-decoration-underline"> MedSky Airline.</span></p>
