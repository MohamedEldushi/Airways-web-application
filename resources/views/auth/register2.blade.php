...
@endif
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 form-floating">
                        <select class="form-select" id="nationality" aria-label="Floating label select example" name="nationality">
                ...
                <div class="row g-3">
                    <div class="col-md-3 form-floating">
                        <select class="form-select" id="country" aria-label="Floating label select example"name="country" >
                            <option class="text-secondary" selected>Select</option>
                    ...
                    <div class="col-md-3 form-floating">
                        <select class="form-select" id="city" aria-label="Floating label select example"name="city"  >
                ...
                <div class="form-check my-3">
                  ...
                  <div class="d-flex justify-content-center mb-5 mt-5">
                    <button class="w-50 btn btn-lg btn-primary p-3 rounded-1 custom-button mb-5" type="submit">Create an account</button>
                </div>
    </form>
